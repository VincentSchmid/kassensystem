...
urlpatterns = [
    ...
    path('sales-tax/<int:pk>/', SalesTaxRetrieveUpdateDestroyView.as_view(), name='sales-tax-detail'),
    ...
    path('menu-item/<int:pk>/', MenuItemRetrieveUpdateDestroyView.as_view(), name='menuitem-detail'),
]
